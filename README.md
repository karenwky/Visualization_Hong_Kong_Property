...
* Check out the complete workflow with [Google Slides](). 
* Check out the complete code with [Jupyter Notebook](https://github.com/yyzz1010/Visualization_Hong_Kong_Property/tree/master/code). 
